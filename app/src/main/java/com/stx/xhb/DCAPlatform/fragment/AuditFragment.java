...
import com.stx.xhb.DCAPlatform.activities.AuditEventActivity;
...
public class AuditFragment extends Fragment implements View.OnTouchListener{
    ...
    //点击事件
    @OnClick({R.id.setting_iv_ch,R.id.setting_iv_clearCache,R.id.setting_iv_out, R.id.setting_iv_about,R.id.ac_registered,R.id.ac_underway,R.id.head_portrait,R.id.username})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ac_registered:
                Intent intent1 = new Intent(getActivity(), AuditEventActivity.class);
                intent1.putExtra("Type","1");
                startActivity(intent1);
                break;
            case R.id.ac_underway:
                Intent intent2 = new Intent(getActivity(), AuditEventActivity.class);
