...
import com.stx.xhb.DCAPlatform.activities.AdminEventActivity;
import com.stx.xhb.DCAPlatform.activities.ChangeActivity;
import com.stx.xhb.DCAPlatform.activities.CreateEventActivity;
import com.stx.xhb.DCAPlatform.activities.LoginActivity;
import com.stx.xhb.DCAPlatform.activities.SendMessageActivity;
...
public class AdministratorFragment extends Fragment implements View.OnTouchListener{
    ...
    //点击事件
    @OnClick({R.id.setting_iv_ch,R.id.setting_iv_clearCache,R.id.ac_upload,R.id.ac_audit,R.id.create,R.id.setting_iv_out,R.id.setting_iv_about,R.id.ac_registered,R.id.ac_end,R.id.ac_underway,R.id.message,R.id.head_portrait,R.id.username})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ac_registered:
                Intent intent1 = new Intent(getActivity(), AdminEventActivity.class);
                intent1.putExtra("Type","1");
                startActivity(intent1);
                break;
            case R.id.ac_underway:
                Intent intent2 = new Intent(getActivity(), AdminEventActivity.class);
                intent2.putExtra("Type","2");
                startActivity(intent2);
                break;
            case R.id.ac_upload:
                Intent intent3 = new Intent(getActivity(),AdminEventActivity.class);
                intent3.putExtra("Type","3");
                startActivity(intent3);
                break;
            case R.id.ac_audit:
                Intent intent4 = new Intent(getActivity(), AdminEventActivity.class);
                intent4.putExtra("Type","4");
                startActivity(intent4);
                break;
            case R.id.ac_end:
                Intent intent5 = new Intent(getActivity(), AdminEventActivity.class);
            ...
            case R.id.setting_iv_about://关于
                ...
                startActivity(about);
                break;
            case R.id.create://创建赛事
                Intent audit = new Intent(getActivity(), CreateEventActivity.class);
                startActivity(audit);
                break;
            case R.id.message://发送信息
                Intent Message = new Intent(getActivity(), SendMessageActivity.class);
